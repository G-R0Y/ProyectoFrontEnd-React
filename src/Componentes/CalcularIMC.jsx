      ...
      <>
         <div className="col-md-5 col-sm-8 col-12 mb-5 ">
            <div className=" col-12 mb-4 text-md-start text-center datos-title">
               <h3>
                  <span>I</span>ndice de <span>M</span>asa <span>C</span>orporal
               </h3>
               <h1>
                  ¿Sabes cual es tu <span>IMC</span>?
               </h1>
            </div>
            ...
            <div className="col-12 ">
               <div className="row px-3 d-flex justify-content-sm-between justify-content-evenly align-items-center mt-2 datos-btn ">
                  ...
                  <label
                     className="col-5 text-end resultadoIMC"
                     style={{ display: valor.display }}
                  >
                     Su IMC es de {valor.valIMC.toFixed(2)}
                  </label>
                  <p className="mt-2">
                     <span>*</span> Datos Obigatorios
                  </p>
               </div>
            </div>
         </div>
